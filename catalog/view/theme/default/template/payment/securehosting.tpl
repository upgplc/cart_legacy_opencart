<form id="securehostingcheckout" action="<?php echo $action; ?>" method="post">
    ...
    <input type="hidden" name="transactionamount" value="<?php echo number_format($transactionamount, 2); ?>"/>
    <input type="hidden" name="transactioncurrency" value="<?php echo $transactioncurrency; ?>"/>
    <input type="hidden" name="transactiontax" value="<?php echo number_format($transactiontax,2); ?>"/>
    <input type="hidden" name="shippingcharge" value="<?php echo number_format($shippingcharge,2); ?>"/>
...
<div class="buttons">
    <div class="pull-right">
        <input type="button" onclick="confirmSubmit();" value="<?php echo $button_confirm; ?>" id="button-confirm"

            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    <tr>
                        ...
                        <td><input type="text" name="securehosting_shreference"
                                   value="<?php echo $securehosting_shreference; ?>"/>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="securehosting_checkcode"
                                   value="<?php echo $securehosting_checkcode; ?>"/>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="securehosting_filename"
                                   value="<?php echo $securehosting_filename; ?>"/>
                    ...
                    <tr>
                        ...
                        <td><select name="securehosting_as"
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="securehosting_as_phrase"
                                   value="<?php echo $securehosting_as_phrase; ?>" <?php if(!$securehosting_as) echo 'disabled="disabled"' ?>
                            />
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="securehosting_as_referrer"
                                   value="<?php echo $securehosting_as_referrer; ?>" <?php if(!$securehosting_as) echo 'disabled="disabled"' ?>
                            />
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="securehosting_sharedsecret"
                                   value="<?php echo $securehosting_sharedsecret; ?>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="securehosting_sort_order"
                                   value="<?php echo $securehosting_sort_order; ?>" size="1"/></td>
                    </tr>
                </table>
            </form>
        </div>
